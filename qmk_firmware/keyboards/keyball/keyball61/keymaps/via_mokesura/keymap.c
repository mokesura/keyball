...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_RSFT  , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                  KC_H     ,LT(3,KC_J), KC_K     , KC_L     , KC_MINS  , KC_ENT   ,
    KC_LCTL  , KC_Z    ,ALT_T(KC_X), KC_C     , KC_V     , KC_B     , _______  ,            _______  , KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_INT1  ,
    MO(1)    , KC_LGUI  , XXXXXXX , XXXXXXX , XXXXXXX ,LT(2,KC_LNG2),CTL_T(KC_SPC),  SFT_T(KC_ENT),LT(3,KC_LNG1), KC_DEL   , KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT
  ),

  [1] = LAYOUT_universal( // Mouse
  ...
  [2] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , S(KC_1)  , S(KC_2)  , S(KC_3)  , S(KC_4)  , S(KC_5)  ,                                  S(KC_6)  , S(KC_7)  , S(KC_8)  , S(KC_9)  ,S(KC_INT1), _______  ,
    _______  , _______  , KC_4     , KC_5     , KC_6     ,S(KC_SCLN),                                  KC_PGUP  , KC_BSLS  , KC_DOWN  , KC_BTN2  , KC_BTN3  , _______  ,
    _______  , _______  , KC_1     , KC_2     , KC_3     ,S(KC_MINS), _______  ,            _______  , KC_PGDN  ,S(KC_BSLS), _______  , _______  , _______  , _______  ,
    _______  , _______  , XXXXXXX  , XXXXXXX  , XXXXXXX  , _______  , _______  ,            _______  , _______  , _______  , _______  , _______  , _______  , _______
  ),
  ...
  [3] = LAYOUT_universal(
    ...
    _______  , S(KC_A)  ,S(KC_RBRC),S(KC_NUHS), KC_RBRC  , KC_NUHS  ,                                  KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , KC_BSPC  , _______  ,
